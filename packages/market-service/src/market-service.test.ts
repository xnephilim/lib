...
const jinxyFindAllMock = jest.fn().mockImplementation(() => mockJinxyMarketData)
const jinxyFindByAssetIdMock = jest.fn().mockImplementation(() => mockJinxyMarketData)
const jinxyFindPriceHistoryByAssetIdMock = jest
  .fn()
...
jest.mock('./jinxy/jinxy', () => ({
  JinxyMarketService: jest.fn().mockImplementation(() => {
    return {
      findAll: jinxyFindAllMock,
      findByAssetId: jinxyFindByAssetIdMock,
      findPriceHistoryByAssetId: jinxyFindPriceHistoryByAssetIdMock,
    }
  }),
}))
...
describe('market service', () => {
  ...
  describe('findAll', () => {
    ...
    it('errors if no data found', async () => {
      ...
      jinxyFindAllMock.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      jinxyFindByAssetIdMock.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findPriceHistoryByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      jinxyFindPriceHistoryByAssetIdMock.mockRejectedValueOnce({ error: 'error' })
