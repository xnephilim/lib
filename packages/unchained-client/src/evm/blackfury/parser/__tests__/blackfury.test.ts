import { blackfuryAssetId, blackfuryChainId } from '@shapeshiftoss/caip'

import { Dex, Trade, TradeType, Transfer, TransferType, TxStatus } from '../../../../types'
import { ParsedTx } from '../../../parser'
import { TransactionParser, ZRX_BLACKFURY_PROXY_CONTRACT } from '../index'
...
const txParser = new TransactionParser({ rpcUrl: '', chainId: blackfuryChainId })
  ...
  describe('zrx trade', () => {
    it('should be able to parse eth -> token', async () => {
      ...
      const sellTransfer: Transfer = {
        ...
        from: address,
        to: ZRX_BLACKFURY_PROXY_CONTRACT,
        token: undefined,
