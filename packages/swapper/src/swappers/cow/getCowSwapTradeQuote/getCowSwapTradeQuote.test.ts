...
import { ETH, JINX, WETH } from '../../utils/test-data/assets'
...
jest.mock('../getCowSwapMinMax/getCowSwapMinMax', () => {
  return {
    getCowSwapMinMax: (_args: CowSwapperDeps, sellAsset: Asset) => {
      if (sellAsset.assetId === JINX.assetId) {
...
const expectedTradeQuoteWethToJinx: TradeQuote<KnownChainIds.EthereumMainnet> = {
  ...
  buyAmountCryptoBaseUnit: '14501811818247595090576', // 14501 JINX
...
const expectedTradeQuoteSmallAmountWethToJinx: TradeQuote<KnownChainIds.EthereumMainnet> = {
  ...
  buyAmountCryptoBaseUnit: '0', // 0 JINX
  sources: [{ name: SwapperName.CowSwap, proportion: '1' }],
  allowanceContract: '0xc92e8bdf79f0507f65a392b0ab4667716bfe0110',
  buyAsset: JINX,
  sellAsset: WETH,
